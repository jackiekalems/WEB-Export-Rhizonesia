<section class="mx-10 mt-10" id="about">
    <div class="container flex flex-col-reverse mx-auto lg:flex-row">
        <div class="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 ">
            ...
            <h2>HENAN LINGLUFENG TRADING CO., LTD</h2>
            <p>Our company dedicated in Imp&Exp trade of fruits, vegetables and foodstuffs. As an international trading
                and manufacturing combo company with definite strength, we serve our customers more than 40 countries in
                global.</p>
