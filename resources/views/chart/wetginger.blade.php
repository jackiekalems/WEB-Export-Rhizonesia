                                            ...
                                            <div class="accordion-content pt-0 overflow-hidden" x-show="open"
                                                ...
                                                <table class="w-full text-sm leading-5">
                                                    <thead class="bg-gray-100">
                                                        <tr>
                                                            <th class="py-2 px-4 text-left font-medium text-gray-600">Detail
                                                            </th>
                                                            <th class="py-2 px-4 text-left font-medium text-gray-600">
                                                                Specification</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">
                                                                Product Name</td>
                                                            <td class="py-2 px-4 text-left">Fresh Ginger</td>
                                                        </tr>
                                                        <tr class="bg-gray-50">
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">Size
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">
                                                                Harvest Age</td>
                                                            <td class="py-2 px-4 text-left">12 Months +</td>
                                                        </tr>
                                                        <tr class="bg-gray-50">
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">
                                                                Condition</td>
                                                            <td class="py-2 px-4 text-left">Washed and Dry</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">Dust
                                                            </td>
                                                            <td class="py-2 px-4 text-left">Removed</td>
                                                        </tr>
                                                        <tr class="bg-gray-50">
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">
                                                                Standardization</td>
                                                            <td class="py-2 px-4 text-left">Fumigated & Quarantine Inspected
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-2 px-4 text-left font-medium text-gray-600">Port
                                                            </td>
                                                            <td class="py-2 px-4 text-left">
                                                                <ul class="list-disc pl-4">
