...
@section('tumericpowder')
    <div class="font-sans bg-white">
        ...
        <div class="p-4 lg:max-w-7xl max-w-4xl mx-auto">
            <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-primary p-6 rounded-lg border">
                    ...
                    <div class="md:flex-1 px-4 border rounded-lg drop-shadow-xl shadow-primary">
                        <div x-data="{ image: 1 }" x-cloak>
                            <div class="h-64 md:h-96 rounded-lg bg-gray-100 my-4">
                                <img src="assets/TurmericPowder/IMG_8807.jpg" x-show="image === 1"
                                    class="h-64 w-full md:h-96 rounded-lg bg-gray-100 mb-4 flex items-center object-cover">
                                </img>

                                <img src="assets/TurmericPowder/IMG_8808.jpg" x-show="image === 2"
                                    class="h-64 w-full md:h-96 rounded-lg bg-gray-100 mb-4 flex items-center object-cover">
                                </img>

                                <img src="assets/TurmericPowder/IMG_8806.jpg" x-show="image === 3"
                                    class="h-64 w-full md:h-96 rounded-lg bg-gray-100 mb-4 flex items-center object-cover">
                                </img>

                                <img src="assets/TurmericPowder/IMG_8810.jpg" x-show="image === 4"
                                    class="h-64 w-full md:h-96 rounded-lg bg-gray-100 mb-4 flex items-center object-cover">
                                </img>
                            </div>
                                ...
                                <template x-for="i in 4">
                                    <div class="flex-1 px-2">
                                        <button x-on:click="image = i"
                                            ...
                                            <img :src="[
                                                'assets/TurmericPowder/IMG_8807.jpg',
                                                'assets/TurmericPowder/IMG_8808.jpg',
                                                'assets/TurmericPowder/IMG_8806.jpg',
                                                'assets/TurmericPowder/IMG_8810.jpg'
                                            ][i - 1]"
                ...
                <div class="lg:col-span-2 border p-5 rounded-lg shadow-primary">
                    <h2
                        ...
                        Export-quality turmeric powder is made using the best ingredients originating from Indonesia |
                        Turmeric Powder</h2>
