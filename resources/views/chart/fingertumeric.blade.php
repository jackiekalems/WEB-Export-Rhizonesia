            ...
            <div
                    ...
                    <div class="md:flex-1 px-4">
                        <div x-data="{ image: 1 }" x-cloak>
                            <div class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4">
                                <img src="https://img.freepik.com/premium-photo/close-up-turmeric-curcuma-longa-linn-rhizome-root-cutting-isolated-white-background_252965-519.jpg?w=996"
                                    x-show="image === 1"
                                ...
                                <template x-for="i in 4">
                                    <div class="flex-1 px-2">
                                        <button x-on:click="image = i"
                                            ...
                                            <img :src="[
                                                'https://img.freepik.com/premium-photo/close-up-turmeric-curcuma-longa-linn-rhizome-root-cutting-isolated-white-background_252965-519.jpg?w=996',
                ...
                <div class="lg:col-span-2">
                    <h2
                        ...
                        Wholesale Ginger China Ginger Export | Finger Turmeric</h2>
