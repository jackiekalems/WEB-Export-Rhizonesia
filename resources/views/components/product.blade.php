<section class="my-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-24">
            <h1 class="text-4xl font-bold text-uppercase">PRODUCT<span class="text-green-400"> CENTER</span></h1>
                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <div class=" w-full lg:w-48 h-64">
                            <img src="assets/product1.jpg" alt="image"
                                class="rounded-2xl h-full border object-contain mx-auto lg:mx-0 lg:w-full">
                        </div>
                        <div class="text-center lg:text-left lg:max-w-xs flex-1">
                            <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                <h6 class="text-lg text-gray-900 font-semibold mb-1">Sweet Corn</h6>
